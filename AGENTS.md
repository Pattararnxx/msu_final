...
โปรเจกต์นี้คือผู้ช่วยจัดการ **ร้านอาหารเช้า** เช่น โจ๊ก ข้าวต้ม และก๋วยจั๊บ
สำหรับเจ้าของร้านหรือพนักงานหน้าร้าน โดยมี workflow หลักดังนี้:

1. รับภาพใบออร์เดอร์หลายใบ รวมถึงลายมือภาษาไทย
2. ใช้ AI/OCR แปลงภาพเป็นรายการเมนู จำนวน และคำสั่งพิเศษ พร้อมระดับความมั่นใจ
3. รวมรายการที่ซ้ำกันจากหลายใบและให้พนักงานตรวจทานรายการที่ AI ไม่มั่นใจ
4. คำนวณยอดและจัดทำใบเสร็จจากข้อมูลเมนู/ราคาที่ร้านกำหนด
5. ประมาณการวัตถุดิบที่ต้องเตรียมจากยอดขายและสูตรมาตรฐานของร้าน

ผลลัพธ์ของ AI เป็นคำแนะนำเพื่อช่วยงาน ไม่ใช่ข้อมูลที่ยืนยันโดยอัตโนมัติ:
ราคา สูตร และวัตถุดิบต้องอ้างอิงจากข้อมูลที่ร้านตั้งไว้ และรายการที่อ่านไม่ชัด
ต้องมี human review ก่อนนำไปคิดเงินหรือเตรียมครัว เอกสารรายละเอียดของ product
context อยู่ใน `docs/Hackathon_MSU_2026_Restaurant_Operations.md` และ `README.md`
